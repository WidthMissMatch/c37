...
architecture behavioral of c37118_packet_formatter_6ch is
    ...
    signal phase_cap_ch1    : std_logic_vector(PHASE_WIDTH-1 downto 0);
    ...
    signal phase_cap_ch2    : std_logic_vector(PHASE_WIDTH-1 downto 0);
    signal mag_cap_ch3      : std_logic_vector(31 downto 0);
    signal phase_cap_ch3    : std_logic_vector(PHASE_WIDTH-1 downto 0);
    signal mag_cap_ch4      : std_logic_vector(31 downto 0);
    signal phase_cap_ch4    : std_logic_vector(PHASE_WIDTH-1 downto 0);
    signal mag_cap_ch5      : std_logic_vector(31 downto 0);
    signal phase_cap_ch5    : std_logic_vector(PHASE_WIDTH-1 downto 0);
    signal mag_cap_ch6      : std_logic_vector(31 downto 0);
    signal phase_cap_ch6    : std_logic_vector(PHASE_WIDTH-1 downto 0);
                ...
                when SEND_WORD =>
                    ...
                    if m_axis_tready = '1' then
                        ...
                        case word_idx is
                            ...
                            when 5 =>
                                word_buffer <= phase_cap_ch1;
                                m_axis_tdata <= phase_cap_ch1;
                            when 6 =>
                            ...
                            when 9 =>
                                word_buffer <= phase_cap_ch2;
                                m_axis_tdata <= phase_cap_ch2;
                            when 10 =>
                                word_buffer <= mag_cap_ch3;
                                m_axis_tdata <= mag_cap_ch3;
                            when 11 =>
                                word_buffer <= phase_cap_ch3;
                                m_axis_tdata <= phase_cap_ch3;
                            when 12 =>
                                word_buffer <= mag_cap_ch4;
                                m_axis_tdata <= mag_cap_ch4;
                            when 13 =>
                                word_buffer <= phase_cap_ch4;
                                m_axis_tdata <= phase_cap_ch4;
                            when 14 =>
                                word_buffer <= mag_cap_ch5;
                                m_axis_tdata <= mag_cap_ch5;
                            when 15 =>
                                word_buffer <= phase_cap_ch5;
                                m_axis_tdata <= phase_cap_ch5;
                            when 16 =>
                                word_buffer <= mag_cap_ch6;
                                m_axis_tdata <= mag_cap_ch6;
                            when 17 =>
                                word_buffer <= phase_cap_ch6;
                                m_axis_tdata <= phase_cap_ch6;
                            when others =>
                                word_buffer <= (others => '0');
                                m_axis_tdata <= (others => '0');
                        end case;
