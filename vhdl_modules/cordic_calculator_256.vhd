...
architecture behavioral of cordic_calculator_256 is
    ...
    type atan_table_type is array (0 to 29) of signed(ANGLE_WIDTH-1 downto 0);
    constant ATAN_TABLE : atan_table_type := (
        to_signed(421657428, ANGLE_WIDTH),
        to_signed(248918914, ANGLE_WIDTH),
        to_signed(131521918, ANGLE_WIDTH),
        to_signed(66762579,  ANGLE_WIDTH),
        to_signed(33510843,  ANGLE_WIDTH),
        to_signed(16771757,  ANGLE_WIDTH),
        to_signed(8388437,   ANGLE_WIDTH),
        to_signed(4194283,   ANGLE_WIDTH),
        to_signed(2097150,   ANGLE_WIDTH),
        to_signed(1048576,   ANGLE_WIDTH),
        to_signed(524288,    ANGLE_WIDTH),
        to_signed(262144,    ANGLE_WIDTH),
        to_signed(131072,    ANGLE_WIDTH),
        to_signed(65536,     ANGLE_WIDTH),
        to_signed(32768,     ANGLE_WIDTH),
        to_signed(16384,     ANGLE_WIDTH),
        to_signed(8192,      ANGLE_WIDTH),
        to_signed(4096,      ANGLE_WIDTH),
        to_signed(2048,      ANGLE_WIDTH),
        to_signed(1024,      ANGLE_WIDTH),
        to_signed(512,       ANGLE_WIDTH),
    ...
    constant PI_HALF : signed(ANGLE_WIDTH-1 downto 0) := to_signed(843314857,  ANGLE_WIDTH);
    constant PI_FULL : signed(ANGLE_WIDTH-1 downto 0) := to_signed(1686629713, ANGLE_WIDTH);
